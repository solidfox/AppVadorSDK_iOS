#
#  Be sure to run `pod spec lint AppVadorSDK_iOS.podspec' to ensure this is a
...
TODOTODO
  ...
  s.homepage     = "https://github.com/solidfox/AppVadorSDK_iOS"
  ...
  s.author             = { "Daniel Schlaug" => "dschlaug@kth.se" }
  # Or just: s.author    = "Daniel Schlaug"
  # s.authors            = { "Daniel Schlaug" => "dschlaug@kth.se" }
  # s.social_media_url   = "http://twitter.com/Daniel Schlaug"
  ...
  s.source_files  = "AppVadorSDK.framework/Headers/*"
